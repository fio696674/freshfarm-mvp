...
const navItems = [
  ...
  { label: "UGC", href: "/dashboard/ugc", icon: Image },
];

/**
 * Vertical navigation sidebar for the customer dashboard.
 * Renders a fixed-width sidebar on desktop and a Sheet (slide-in) on mobile.
 */
